...
function BildeSeksjon() {
  return (
      <section className="flex justify-center items-center gap-28  w-screen   max-h-[800px] overflow-hidden bg-[#F9C66B]  ">
      ...
      <div className='rotate-30 pt-72'>
        <img src={image5} alt="startparkering" className="w-96 h-auto pt-20 pb-8" />
